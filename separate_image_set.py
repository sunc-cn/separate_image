...
def separate_image(raw_file_name,dst_dir):
    ...
    for k, col in zip(range(n_clusters), colors):
        ...
        toi.save(dst_dir + "/" + raw_name +"_"+ str(map_index_dict[k]) +"_" + map_dict[k] + ".jpg")
...
def main(image_dir,dst_dir):
    ...
    for item in all_files:
        separate_image(item,dst_dir)

if __name__ == "__main__":
    src_image_dir = "./test_set"
    dst_image_dir = "./test_set_single"
    main(src_image_dir,dst_image_dir)
